...
public class GlobalFragment extends Fragment implements View.OnClickListener {
    ...
    CoronaListener<Global> globalListener = new CoronaListener<Global>() {
        ...
        public void onSuccess(Global items) {
            confirmed = String.valueOf(items.getTotalConfirmed());
            tvConfirmed.setText(convertValue(confirmed));

            deaths = String.valueOf(items.getTotalDeaths());
            tvDeaths.setText(convertValue(deaths));

            recovered = String.valueOf(items.getTotalRecovered());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_value_confirmed_global:
                ...
                break;
            case R.id.tv_value_deaths_global:
                if (parameterB == 0){
                    tvDeaths.setText(convertValue(deaths));
                    parameterB = 1;
                } else {
                ...
                break;
            case R.id.tv_value_recovered_global:
                if (parameterC == 0){
                    tvRecovered.setText(convertValue(recovered));
                    parameterC = 1;
                } else {
